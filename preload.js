   ...
   //tem que carregar tudo antes para conseguir rodar 
    preload() {
        ...
        this.load.image('gameover', 'fundo/gameouver.png');
        this.load.image('nivelVencido', 'fundo/nivelvencido.png');
        ...
        this.load.image('plataforma_mola', 'fundo/mola.png');
        ...
        this.load.image('inimigo2', 'inimigos/inimigo_plataforma.png');
        ...
        this.load.audio('musicaGameOver', 'musicas/gameOver_1.wav');
        this.load.audio('musicaNivelVencido', 'musicas/musica_nivelVencido.wav');
    ...
    create (){
         ...
         this.anims.create({
            ...
            frameRate: 3, //movimentação dele andar 
        ...
        this.anims.create({
            ...
            frameRate: 6, //movimentação dele pular 
            repeat: -1
            //.setBounce(.4)
        })
